  ...
  <div>
    ...
    <div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-3 xl:gap-12 pb-3">
        ...
        >
          <h3
            class="text-lg md:text-xl mb-2 text-blue-500 font-bold border-b-2 border-blue-500"
          >
            寄付によるサポート
          </h3>
          <p class="pb-3">
          ...
          <div class="text-center">
            ...
            >
              <nuxt-link to="/donation/">寄付でサポートする</nuxt-link>
            </button>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div class="text-center">
            <button
              class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded"
            >
              <nuxt-link to="/pro-bono/">メンバーとしてサポートする</nuxt-link>
            </button>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div class="text-center">
            <button
              class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded"
            >
              <nuxt-link to="/request/">講演依頼などを申し込む</nuxt-link>
            </button>
          </div>
        </div>
      </div>
